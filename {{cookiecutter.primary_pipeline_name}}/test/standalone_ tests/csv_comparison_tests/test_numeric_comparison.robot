...
...                 robot --outputdir robot_output "{{cookiecutter.primary_pipeline_name}}/test/standalone_ tests/csv_comparison_tests/test_numeric_comparison.robot"
...
...                 Or from {{cookiecutter.primary_pipeline_name}}/test directory:
...                 robot --outputdir robot_output "standalone_ tests/csv_comparison_tests/test_numeric_comparison.robot"
...
