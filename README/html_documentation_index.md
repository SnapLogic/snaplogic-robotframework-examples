...
| Document Name                  | Description                                            | Relative Path                                                                                   | GitHub Link                                                                                                                                                                                                             |
| ------------------------------ | ------------------------------------------------------ | ----------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Salesforce Django Mock Server &mdash; URL Routing Guide | How the Salesforce Django mock server routes incoming requests, plus configuration tips for local SOAP/REST testing. | `README/How To Guides/infra_setup_guides/salesforce/salesforce-django-mock-server-url-routing-guide.html` | [Open](https://htmlpreview.github.io/?https://github.com/SnapLogic/snaplogic-robotframework-examples/blob/main/README/How%20To%20Guides/infra_setup_guides/salesforce/salesforce-django-mock-server-url-routing-guide.html) |
