# Mock Services Research Documents (HTML Format)

> Interactive HTML research documents for mock service options used in SnapLogic pipeline testing.
> Click the links below to view them directly in your browser via GitHub HTML Preview.

---

## 1. SAP Mock Server Guide
...
## 2. Snowflake DB Emulation Research & Options Analysis
