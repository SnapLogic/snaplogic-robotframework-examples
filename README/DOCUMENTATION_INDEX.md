...
|---------------|-------------|---------------|-------------|
| Prerequisites | System requirements and software dependencies | `README/Tutorials/HTML DOCS/01_prerequisites.html` | [Open](https://htmlpreview.github.io/?https://github.com/SnapLogic/snaplogic-robotframework-examples/blob/main/README/Tutorials/HTML%20DOCS/01_prerequisites.html) |
| Architecture Overview | High-level architecture and component overview | `README/Tutorials/HTML DOCS/02_architecture_overview.html` | [Open](https://htmlpreview.github.io/?https://github.com/SnapLogic/snaplogic-robotframework-examples/blob/main/README/Tutorials/HTML%20DOCS/02_architecture_overview.html) |
| VS Code Setup Guide | IDE configuration and extensions setup | `README/Tutorials/HTML DOCS/03_vscode_setup_guide.html` | [Open](https://htmlpreview.github.io/?https://github.com/SnapLogic/snaplogic-robotframework-examples/blob/main/README/Tutorials/HTML%20DOCS/03_vscode_setup_guide.html) |
| Pre-Execution Setup | Configuration and environment setup before running tests | `README/Tutorials/HTML DOCS/04_configuration_setup.html` | [Open](https://htmlpreview.github.io/?https://github.com/SnapLogic/snaplogic-robotframework-examples/blob/main/README/Tutorials/HTML%20DOCS/04_configuration_setup.html) |
| Pipeline Execution Quick Start | Getting started with running your first pipeline test | `README/Tutorials/HTML DOCS/05_pipeline_execution_quickstart.html` | [Open](https://htmlpreview.github.io/?https://github.com/SnapLogic/snaplogic-robotframework-examples/blob/main/README/Tutorials/HTML%20DOCS/05_pipeline_execution_quickstart.html) |
| Testing Phases | Understanding the different phases of test execution | `README/Tutorials/HTML DOCS/06_testing_phases.html` | [Open](https://htmlpreview.github.io/?https://github.com/SnapLogic/snaplogic-robotframework-examples/blob/main/README/Tutorials/HTML%20DOCS/06_testing_phases.html) |
...
| Docker Infrastructure Guide | Docker container setup and management | `README/How To Guides/robot_framework_guides/html_docs/docker_infrastructure_guide.html` | [Open](https://htmlpreview.github.io/?https://github.com/SnapLogic/snaplogic-robotframework-examples/blob/main/README/How%20To%20Guides/robot_framework_guides/html_docs/docker_infrastructure_guide.html) |
...
| Test Initialization Workflow | Understanding the __init__.robot file and suite setup | `README/How To Guides/robot_framework_guides/html_docs/test_initialization_workflow_init_file.html` | [Open](https://htmlpreview.github.io/?https://github.com/SnapLogic/snaplogic-robotframework-examples/blob/main/README/How%20To%20Guides/robot_framework_guides/html_docs/test_initialization_workflow_init_file.html) |
| Triggered Task Guide | Working with SnapLogic triggered tasks in tests | `README/How To Guides/robot_framework_guides/html_docs/triggered_task_guide.html` | [Open](https://htmlpreview.github.io/?https://github.com/SnapLogic/snaplogic-robotframework-examples/blob/main/README/How%20To%20Guides/robot_framework_guides/html_docs/triggered_task_guide.html) |
...
├── Tutorials/
│   └── HTML DOCS/
│       ├── 01_prerequisites.html
│       ├── 02_architecture_overview.html
│       ├── 03_vscode_setup_guide.html
│       ├── 04_configuration_setup.html
│       ├── 05_pipeline_execution_quickstart.html
│       └── 06_testing_phases.html
│
└── How To Guides/
    ...
    └── infra_setup_guides/
        ...
        ├── salesforce/
        │   └── README/
        │       └── stateless vs stateful workflow.html
        ├── windows/
        │   └── windows_wsl_vscode_setup.html
        └── docker_makefile_envfiles_details.html
```
