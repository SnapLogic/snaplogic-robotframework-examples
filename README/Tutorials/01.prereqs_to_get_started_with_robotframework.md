...
> **💡 Viewing on GitHub?** For proper HTML formatting, use this link:
> [🔗 Open in HTML Preview](https://htmlpreview.github.io/?https://github.com/SnapLogic/snaplogic-robotframework-examples/blob/main/README/Tutorials/HTML%20DOCS/Robotframework_end_to_end_workflow_steps.html)
...
### IDE / Terminal Setup
You can use any IDE or terminal of your choice to execute Robot Framework tests. If you prefer using **VS Code**, refer to our setup guide for configuring Robot Framework extensions and environment:
👉 [VS Code Robot Framework Setup Guide](../How%20To%20Guides/infra_setup_guides/vscode/vscode_robot_framework_setup_guide.md)
